...
accelerate launch examples/minimax_h3/model_training/train.py \
  ...
  --output_path "./models/train/MiniMax-H3-VACE-480p-nocaption-cache" \
...
#   --dataset_base_path ./models/train/MiniMax-H3-VACE-720p-nocaption-cache \
#   --data_file_keys "video,input_audio,vace_video" \
#   --extra_inputs "input_audio,vace_video" \
#   --max_pixels 1044480 \
#   --num_frames 39 \
...
#   --save_steps 200 \
#   --remove_prefix_in_ckpt "pipe.vace." \
#   --output_path "./models/train/MiniMax-H3-VACE-720p-nocaption" \
#   --trainable_models "vace" \
