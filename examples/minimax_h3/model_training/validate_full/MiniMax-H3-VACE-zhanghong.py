...
state_dict = load_state_dict("/mnt/nas3/sunyuzework/myown/DiffSynth-Studio/models/train/MiniMax-H3-VACE-720p-nocaption/step-6200.safetensors")
...
write_video_audio(
    video=video, audio=audio, output_path="minimax_h3_vace_720p-6200-1-10-2.mp4",
