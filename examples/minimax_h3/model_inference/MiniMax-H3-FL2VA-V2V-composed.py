...
controlnet_vram_config = {
    # Due to the format conversion required for the ControlNet, disk offloading is not supported.
    "offload_dtype": torch.bfloat16,
    "offload_device": "cpu",
    "onload_dtype": torch.bfloat16,
    "onload_device": "cpu",
...
pipe.load_lora(pipe.dit, "/mnt/nas3/sunyuzework/Diffutoon-2/DiffSynth-Studio/models/train/MiniMax-H3-ToonLoRA-split/step-4000.safetensors")
...
# )
control_video = VideoData("/mnt/nas3/sunyuzework/myown/DiffSynth-Studio/data/diffsynth_example_dataset/minimax_h3/MiniMax-H3-Ref2VA/video_lineart.mp4", height=704, width=1344)
...
video, audio = pipe(
    ...
    denoising_strength=0.8, control_video=control_video, control_scale=1,
)
# video, audio = pipe(
#     prompt=prompt,
#     height=704, width=1344, num_frames=124, num_inference_steps=4, seed=1, flow_shift=6.0,
#     input_video=source_video,
#     denoising_strength=0.95, control_video=control_video, control_scale=1,
# )
write_video_audio(
    video=video, audio=audio,
    output_path="v2va_with_audio-step3-09-compose-all-nocaption-08.mp4", fps=24, audio_sample_rate=32000,
)
